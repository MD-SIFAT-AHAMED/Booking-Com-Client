  ...
  return (
    <div className="card bg-base-100 shadow-md hover:shadow-xl transition group cursor-pointer">
      ...
      <div className="card-body">
        <h2 className="text-base text-secondary lg:text-lg font-semibold">
          {title}
        </h2>
        ...
        <div className="flex justify-between items-center mt-2">
          ...
          <div className="hidden lg:flex">
            <p className="text-[#876527] text-xs md:text-sm font-semibold">
              ${price}/night
            </p>
          </div>
        </div>
        <div className="lg:hidden">
          <p className="text-[#5a4317] text-xs md:text-sm font-semibold">
            ${price}/night
          </p>
        </div>
