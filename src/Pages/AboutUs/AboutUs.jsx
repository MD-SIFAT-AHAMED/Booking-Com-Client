...
const AboutUs = () => {
  ...
  return (
    <div>
      <div className="max-w-screen-2xl min-h-80 w-11/12 mx-auto md:p-2 my-10">
        <HeaderSection 
        title="About Us"
        />
        <p className="text-sm md:text-lg w-9/10 mx-auto text-center leading-7">
        ...
        <p className="text-sm md:text-lg  w-9/10 mx-auto mt-4 text-center leading-7">
